  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        arabic: ['"Uthmanic Hafs"', '"Amiri Quran"', 'Amiri', '"Noto Naskh Arabic"', '"Geeza Pro"', '"Times New Roman"', 'serif'],
        mushaf: ['"Uthmanic Hafs"', '"Amiri Quran"', 'Amiri', '"Noto Naskh Arabic"', '"Geeza Pro"', 'serif'],
      },
      borderRadius: {
        lg: '0.75rem',
        xl: '1rem',
